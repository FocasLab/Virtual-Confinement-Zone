...
int main() {
  ...
  state_type s_lb={{-1.0,-1.0}};
  
  /* upper bounds of the hyper rectangle */
  state_type s_ub={{1.0,1.0}};
  ...
  /* lower bounds of the hyper rectangle */
  input_type i_lb={{-0.2,-0.2}};

  /* upper bounds of the hyper rectangle */
  input_type i_ub={{ 0.2, 0.2}};
  ...
  auto target = [&ss,&s_eta](const abs_type& idx) {
    ...
    // if (0.25 <= (x[0]-s_eta[0]/2.0) && (x[0]+s_eta[0]/2.0) <= 0.4 && 
    //     0.15 <= (x[1]-s_eta[1]/2.0) && (x[1]+s_eta[1]/2.0) <= 0.25)
    if (0.7 <= (x[0]-s_eta[0]/2.0) && (x[0]+s_eta[0]/2.0) <= 0.8 && 
        -0.8 <= (x[1]-s_eta[1]/2.0) && (x[1]+s_eta[1]/2.0) <= -0.7)
      return true;
    return false;
  };

function [Controlled_delta, Winning_Domain, T] = SimpleDiscreteSystem(n_r, n_states, n_inputs, lb_states, ub_states, lb_inputs, ub_inputs, ...
    s_eta, i_eta, target, obstacles)
    ...
    % lb_states -> Lower bound of states;
    % ub_states -> Upper bound of states;
    % lb_inputs -> Lower bound of inputs;
    % ub_inputs -> Upper bound of inputs;
    % s_eta -> State discretization;
    % i_eta -> Input discretization;
    % target -> Target for reachable specification;
